...
def search_and_train():
    global X_train, y_train  # Para poder usarlos en la función de objective

    with wandb.init(
        project="MLOps-ClassAssigment",
        name=f"Model Selection and Training ExecId-{args.IdExecution}",
        job_type="model-selection"
    ) as run:  
